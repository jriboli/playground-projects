package T012_CustomAnnotationswithTestNG;

import analyzers.RetryAnalyzer;
import com.microsoft.playwright.*;
import com.woocommerce.fluentpages.FluentCartPage;
import com.woocommerce.pages.HomePage;
import customAnnotation.CustomAnnotationListener;
import customAnnotation.CustomSetup;
...
/*
    TODO: This still needs some work. Need to fully understand custom annotations, and their uses.
 */

public class FluentCart_WithCustomAnnotation {
    ...
    @Test
    @CustomSetup(value = "Setting up blah blah")
