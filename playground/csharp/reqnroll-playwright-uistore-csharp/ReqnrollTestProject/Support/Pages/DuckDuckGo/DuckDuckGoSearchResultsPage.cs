...
namespace ReqnrollTestProject.Support.Pages.DuckDuckGo
{
    public class DuckDuckGoSearchResultsPage
    {
        ...
        public DuckDuckGoSearchResultsPage(Support.Hooks hooks)
        {
            _user = hooks.User;
        }
        ...
        private ILocator SearchResults => _user.Locator("div[id='react-layout']");
        ...
        {
            //Assert the page url
            await _user.WaitForURLAsync($"https://duckduckgo.com/?t=h_&q={searchTerm}*");
