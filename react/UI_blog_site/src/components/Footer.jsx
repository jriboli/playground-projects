...
const Footer = () => {
    return (
        <div className="w-full bg-[#02044A] text-gray-300 py-8 px-2">
            <div className="mwx-w-[1240px] mx-auto grid grid-cols-2 md:grid-cols-6 border-b-2 border-gray-600 py-2">
                <div>
                ...
                <div className="col-span-2 pt-2md:pt-2">
                    ...
                    <form className="flex flex-col sm:flex-row">
                        ...
                        <button className="p-2 mb-2 bg-[#00B86E] rounded-md ">Subscribe</button>
                    </form>
                </div>
            </div>
