...
import com.helldivers.populate.models.RandomUserAPI.RandomUser;
import com.helldivers.populate.models.RandomUserAPI.Results;
...
public class PlayerFactory {
    ...
    public static Player createPlayer(String name, String email, String gamerTag, Map<String, Integer> percentages) {
        ...
        return new Player(null, name, email, gamerTag, playerType, null);
    }
